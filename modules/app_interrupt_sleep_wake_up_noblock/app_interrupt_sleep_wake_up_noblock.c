...
int app_interrupt_sleep_wake_up_noblock_init(int argc, char *argv[]){
    ...
    while (1)
    {
        printf("app_interrupt_sleep_wake_up_noblock \n");
...
void app_interrupt_sleep_wake_up_noblock_main(int argc, char *argv[]){
    app_interrupt_sleep_wake_up_noblock_init(argc, argv);
};