...
int app_interrupt_sleep_wake_up_workqueue_init(int argc, char *argv[]){
    ...
    while (1)
    {
        printf("app_interrupt_sleep_wake_up_workqueue \n");
        ...
        printf("app_interrupt_sleep_wake_up_workqueue get value: %d\n", val); 
...
void app_interrupt_sleep_wake_up_workqueue_main(int argc, char *argv[]){
    app_interrupt_sleep_wake_up_workqueue_init(argc, argv);
};