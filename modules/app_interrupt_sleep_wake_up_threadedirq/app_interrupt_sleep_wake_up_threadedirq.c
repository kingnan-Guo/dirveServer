#include "app_interrupt_sleep_wake_up_threadedirq.h"


static int fd;


int app_interrupt_sleep_wake_up_threadedirq_init(int argc, char *argv[]){
    ...
    while (1)
    {
        printf("app_interrupt_sleep_wake_up_threadedirq \n");
        ...
        printf("app_interrupt_sleep_wake_up_threadedirq get value: %d\n", val); 
...
void app_interrupt_sleep_wake_up_threadedirq_main(int argc, char *argv[]){
    app_interrupt_sleep_wake_up_threadedirq_init(argc, argv);
};