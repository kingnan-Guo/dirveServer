...
int app_interrupt_sleep_wake_up_timer_init(int argc, char *argv[]){
...
void app_interrupt_sleep_wake_up_timer_main(int argc, char *argv[]){
    app_interrupt_sleep_wake_up_timer_init(argc, argv);
};