...
static const struct of_device_id of_match_ids[] = {
    { 
...
static const struct my_i2c_device_id my_i2c_driver_ids[] = {
    {
        "chip_name", // i2c设备名字
...
static int my_i2c_driver_probe(struct i2c_client *client) {
    ...
    struct i2c_dirver *i2c_adapter = client->adapter;
...
static int my_i2c_driver_remove(struct i2c_client *client) {
    printk("%s %s %d\n", __FILE__, __FUNCTION__, __LINE__);
